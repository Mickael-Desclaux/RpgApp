...
ALTER TABLE [PlayerCharacter] ADD FOREIGN KEY ([DamageResistanceId]) REFERENCES [DamageResistance] ([Id])
GO

ALTER TABLE [NonPlayerCharacter] ADD FOREIGN KEY ([DamageResistanceId]) REFERENCES [DamageResistance] ([Id])
GO

ALTER TABLE [Monster] ADD FOREIGN KEY ([DamageResistanceId]) REFERENCES [DamageResistance] ([Id])
GO
